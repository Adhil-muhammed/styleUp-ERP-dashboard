...
export function useMerchantTabQueryParams() {
...
type MerchantTabTableProps<TData extends { id: string }> = {
...
export function MerchantTabTable<TData extends { id: string }>({
  columns,
  data,
  isPending,
  isError,
  ...
  onSearchChange,
  renderMobileCard,
}: MerchantTabTableProps<TData>): React.ReactElement {
